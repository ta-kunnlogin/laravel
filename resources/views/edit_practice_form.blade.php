      ...
      <div class="card-body">
        ...
        <div class="card-body">
          <form action="" method="post">
            ...
            <input type='date' class='form-control' name='date' id='date' value="{{$practice->date}}" />

            <label for='morning' class='mt-2'>午前</label>
            <input type='morning' class='form-control' name='morning' id='morning' value="{{$practice->morning}}" />

            <label for='category' class='mt-2'>カテゴリ</label>
            <select name='type_id_1' class='form-control'>
              <option value="" hidden>{{$practice->type_id_1}}</option>
            ...
            <input type='afternoon' class='form-control' name='afternoon' id='afternoon' value="{{$practice->afternoon}}" />

            <label for='category' class='mt-2'>カテゴリ</label>
            <select name='type_id_2' class='form-control'>
              <option value='' hidden>{{$practice->type_id_2}}</option>
              @foreach($categories as $category)
              <option value="{{$category['training_id']}}">{{$category['training']}}</option>
              @endforeach
            </select>
            ...
            <textarea class='form-control' name='comment'>{{$practice->comment}}</textarea>
